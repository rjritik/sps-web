const IconEdit = (props) => {
    return (
        ...
        >
            ...
            />
            <path
                d="M19.852 9.83c-.07 0-.14-.01-.2-.03a7.937 7.937 0 01-5.46-5.46.76.76 0 01.52-.93c.4-.11.81.12.92.52.6 2.13 2.29 3.82 4.42 4.42.4.11.63.53.52.93-.09.34-.39.55-.72.55z"
                fill="#fff"
            />
        </svg>
    );
