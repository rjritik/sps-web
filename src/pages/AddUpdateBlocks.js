...
const AddUpdateBlocks = () => {
    ...
    useEffect(() => {
        if (blockDetails) {
            const qualityGrade =
                blockDetails.blockQualityGrade === "Premium"
                    ? "Premium"
                    : "Commercial";
            ...
            reset({
                ...
                date: parsedDate,
                blockLength:
                    blockDetails.blockDimension?.blockLength?.toString() || "",
                blockWidth:
                    blockDetails.blockDimension?.blockWidth?.toString() || "",
                blockWeight:
                    blockDetails.blockDimension?.blockWeight?.toString() || "",
                blockHeight:
                    blockDetails.blockDimension?.blockHeight?.toString() || "",
                blockVolume:
                    blockDetails.blockDimension?.blockVolume?.toString() || "",
                purchasingUnit:
                    blockDetails.additionalDetails?.purchasingUnit || "",
                truckNumber: blockDetails.additionalDetails?.truckNumber || "",
                invoiceNumber:
                    blockDetails.additionalDetails?.invoiceNumber || "",
                wrappingRequired: blockDetails.additionalDetails
                    ?.wrappingRequired
                    ? "yes"
                    : "no",
            ...
            if (
                isEdit &&
                blockDetails.additionalDetails?.attachments?.length > 0
            ) {
                        ...
                        >
                            ...
                            <div>
                                <Controller
                                    ...
                                    rules={{
                                        required:
                                            "Block Quality Grade is required",
                                    }}
                                    render={({ field }) => (
                                        <RadioGroup
                                            isRequired
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <Dropdown showArrow>
                                            ...
                                            >
                                                <DropdownItem key="White">
                                                    White
                                                </DropdownItem>
                                                <DropdownItem key="Red">
                                                    Red
                                                </DropdownItem>
                                                <DropdownItem key="Black">
                                                    Black
                                                </DropdownItem>
                                                <DropdownItem key="Blue">
                                                    Blue
                                                </DropdownItem>
                                            </DropdownMenu>
                                        </Dropdown>
                        ...
                        >
                            ...
                            <div>
                                <Controller
                                    ...
                                    rules={{
                                        required:
                                            "Wrapping required selection is needed",
                                    }}
                                    render={({ field }) => (
                                        <RadioGroup
                                            isRequired
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-4 mb-2">
                                    Add your image here, and you can upload up
                                    to 5 files max
                                </p>
